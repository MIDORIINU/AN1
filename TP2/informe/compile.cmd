...
REM Usa el compilador de latex instalado y este debe estar en una ruta incluida en PATH (TEXLIve o MikTEX la agregan).
...
REM #*****************************************************
SET informname=TP2_Informe
SET targetdir=.\..\informe-compilado
SET premises=20191114_2do_Trabajo_Numerico.pdf
...
DEL >nul 2>&1 *.aux *.bbl *.blg *.out *.toc *.dvi *.synctex.gz *.table *.gnuplot *.lof *.synctex*  *.lot
IF %dellogfile%==true (
DEL >nul 2>&1 *.log
)
)
