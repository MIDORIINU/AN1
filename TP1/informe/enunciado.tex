...
\begin{figure}[!h] %htb
\begin{center}
\includegraphics[width= \linewidth, keepaspectratio=true, angle=90]{img/grafico_funcion_x.png} %% , angle=90 trim={<left> <lower> <right> <upper>}
...
\begin{figure}[!h] %htb
\begin{center}
\includegraphics[width= \linewidth, keepaspectratio=true, angle=90]{img/grafico_funcion_v.png} %% , angle=90 trim={<left> <lower> <right> <upper>}
...
\begin{figure}[!h] %htb
\begin{center}
\includegraphics[width= \linewidth, keepaspectratio=true, angle=90]{img/grafico_funcion_a.png} %% , angle=90 trim={<left> <lower> <right> <upper>}
