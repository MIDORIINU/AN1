...
\newcommand{\cuatrimestre}{2\sptext{do} cuatrimestre de 2019} %\textsuperscript{er} $2^{do}$
...
\newcommand{\thedate}{10 de Octubre de 2019}
...
%\newcommand{\eqref}[1]{\textcolor{EQColor}{\ref{#1}}}
